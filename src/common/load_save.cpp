...
File LoadSave::getConfigFile() {
  ...
  config_options.applicationName = "Essential";
...
File LoadSave::getDataDirectory() {
  ...
  File directory = home_directory.getChildFile("Music").getChildFile("Essential");
#else
  File documents_dir = File::getSpecialLocation(File::userDocumentsDirectory);
  File directory = documents_dir.getChildFile("Essential");
#endif
